...
```
cd existing_repo
git remote add origin https://gitlab.com/krbaio3/micro-petshop.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/krbaio3/micro-petshop/-/settings/integrations)
...
Use GitFlow or a similar branching model to manage your repository. This makes it easier for contributors to keep their
changes organized and discoverable.
